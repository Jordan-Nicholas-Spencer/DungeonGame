...
public class Shop {
	...
	public static final Weapon STAKE = new Weapon("wooden stake", "according to legend, only a wooden stake through the heart can kill a vampire for good", 50);
	...
	public static final Armor BLESSED = new Armor("blessed", "Your armor has been blessed by the gods themselves", 100);
